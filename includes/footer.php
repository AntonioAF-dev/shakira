<footer>
    <div class="informes">
        <h3 class="pie-pg">Informes</h3>
        <p class="direcciones">Psj. Juan Velasco Alvarado 183</p>
        <p class="direcciones">Cel. Nº 958839291</p>
        <p class="direcciones">Huánuco - Pillco Marca</p>
        <p class="correo">servacosta@gmail.com</p>
    </div>

    <div class="Siguenos">
        <h3 class="pie-pg1">Siguenos en:</h3>
        <ul class="example-2">
            ...
            <li class="icon-content">
                <a href="https://github.com/MarcoAntonioAF" target="_blank" aria-label="GitHub" data-social="github">
                    <div class="filled"></div>
            ...
            <li class="icon-content">
                <a href="https://www.youtube.com/@ServAcosta" target="_blank" aria-label="Youtube" data-social="youtube">
                    <div class="filled"></div>
    ...
    <div class="perfil-footer">
        <a href="https://github.com/MarcoAntonioAF" target="_blank_" class="link-wrapper">
            <p class="dev">Developer<br>AntonioAF</p>
            <img src="assets/img/dev.webp" alt="Desarrollador" />
        </a>
    </div>
